...
SUSE Harvester is deeply committed to safeguarding the security of our products,
...
products within the Harvester ecosystem. Example of valid reports:
...
- Improvements or questions on the security hardening guides. These should be
  ...
  issue](https://github.com/harvester/docs/issues/new/choose).
- Issues or bugs that aren't security related. These should be reported as a new
  [Harvester issue](https://github.com/harvester/harvester/issues/new/choose). 
...
- Issues that are self inflicted and require the user to disable security
  features or downgrade the security of its environment in order for the
...
terms](https://www.suse.com/lifecycle/) to view the current support lifecycle.
...
protect the Harvester ecosystem users and enable us to follow through our
